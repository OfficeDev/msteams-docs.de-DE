...
* [Azure AD Authentifizierung in Registerkarten](~/tabs/how-to/authentication/auth-tab-AAD.md) beschreibt, wie eine Verbindung mit Azure AD von einer Registerkarte in der App in Teams hergestellt wird.
