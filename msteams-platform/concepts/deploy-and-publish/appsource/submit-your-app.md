...
---
# <a name="submit-your-microsoft-teams-app-to-partner-center"></a>Übermitteln Ihrer Microsoft Teams-App an Partner Center

Nach der Vorbereitung Ihrer Store-Übermittlung können Sie Ihre App offiziell zur Überprüfung übermitteln.

## <a name="create-a-partner-center-account"></a>Erstellen eines Partner Center-Kontos

Um Ihre App im Teams und AppSource zu veröffentlichen, müssen Sie zuerst [ein Entwicklerkonto einrichten.](https://docs.microsoft.com/office/dev/store/open-a-developer-account)

## <a name="submit-your-app"></a>Übermitteln Ihrer App

Um Ihre App zu übermitteln, befolgen Sie die folgenden [Schritt-für-Schritt-Store-Übermittlungsanweisungen](https://docs.microsoft.com/office/dev/store/add-in-submission-guide). Geben Sie beim Erstellen einer neuen Übermittlung an, dass Sie eine Teams übermitteln.

### <a name="app-category-mapping"></a>Zuordnung von App-Kategorie

Während der Übermittlung werden Sie aufgefordert, Ihre App zu kategorisieren. In der folgenden Tabelle werden Teams den im Partner Center aufgeführten Kategorien zugeordnet.
...
### <a name="3-fix-issues-with-your-submission"></a>3. Beheben von Problemen mit Ihrer Übermittlung

Wenn die Übermittlung ihrer App fehlschlägt, erhalten Sie einen Fehlerbericht, damit Sie wissen, was sie beheben und erneut übermitteln müssen. Microsoft bietet auch einen White-Glove-Dienst, mit dem Ihre App aufgelistet werden kann.
...
- Wenn Sie neu im Partner Center sind und kein Konto im Microsoft-Netzwerk haben, erstellen Sie ein Konto mithilfe der [Partner Center-Registrierungsseite](/office/dev/store/open-a-developer-account#create-an-account-using-the-partner-center-enrollment-page).
- Wenn Sie bereits im Partnernetzwerk registriert sind, erstellen Sie ein Konto direkt im Partner Center mithilfe einer vorhandenen [Registrierungsseite](/office/dev/store/open-a-developer-account#create-an-account-using-an-existing-partner-center-enrollment).

### <a name="what-if-i-cant-find-my-office-store-account-in-partner-center"></a>Was passiert, wenn ich mein Konto Office Store Partner Center nicht finden kann?
...
### <a name="how-do-i-manage-my-office-store-account-in-partner-center"></a>Wie verwalte ich mein Office Store im Partner Center?
...
### <a name="why-do-i-receive-the-message-this-account-is-not-publish-eligible-when-i-try-to-submit-my-app"></a>Warum erhalte ich die Meldung "Dieses Konto ist nicht berechtigt zu veröffentlichen", wenn ich versuche, meine App zu übermitteln?

Sie erhalten die obige Fehlermeldung, wenn der [Kontoüberprüfungsstatus](/partner-center/verification-responses) aussteht. Überprüfen Sie den Kontoüberprüfungsstatus im Partner [Center-Dashboard.](https://partner.microsoft.com/dashboard) Wählen **Einstellungen**, das Zahnradsymbol in der oberen rechten Ecke der Seitenkopfshell aus. Wählen **Sie Entwicklereinstellungen**  =>     =>  **Kontokontoeinstellungen aus.**
...
### <a name="my-account-verification-status-hasnt-advanced-beyond-email-ownership-how-should-i-proceed"></a>Der Status der Kontoüberprüfung wurde nicht über den E-Mail-Besitz hinaus erweitert. Wie soll ich vorgehen?
...
### <a name="how-do-i-get-further-support-for-my-account-related-issues"></a>Wie kann ich weitere Unterstützung für meine kontobezogenen Probleme erhalten?
...
### <a name="ive-created-a-support-ticket-and-i-havent-received-an-update-in-7-business-days-where-can-i-get-help"></a>Ich habe ein Supportticket erstellt und habe in 7 Werktagen kein Update erhalten. Wo kann ich Hilfe erhalten?
...
> [Verwalten und Unterstützen Ihrer App](~/concepts/deploy-and-publish/appsource/post-publish/overview.md)
