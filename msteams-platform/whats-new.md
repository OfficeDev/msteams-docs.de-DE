...
| 11/29/2021 |Interaktiver Modus zum Freigeben der Besprechungsphase.|• Erstellen von Apps für Teams Besprechungen > [Freigegebene Besprechungsphase](apps-in-teams-meetings/enable-and-configure-your-app-for-teams-meetings.md#shared-meeting-stage) </br> • Erstellen von Apps für Teams Besprechungen > [API-Referenzen für Besprechungs-Apps](apps-in-teams-meetings/API-references.md) </br> • App-Manifest > Öffentliche Entwicklervorschau > [Entwicklervorschau-Manifestschema](resources/schema/manifest-schema-dev-preview.md)|
...
|10/18/2021| Registerkarten verknüpfen Verbreitung und Phasenansicht. | Erstellen von Registerkarten > [Der Link "Registerkarten" wird angezeigt und die Phasenansicht wird angezeigt.](tabs/tabs-link-unfurling.md) |
...
|08/30/2021| Die Szenenfunktion für den benutzerdefinierten Modus kombiniert Teilnehmer in einer einzelnen virtuellen Szene und platziert ihre Videostreams auf vordefinierten Arbeitsplätzen.| Erstellen von Apps für Teams Besprechungen > [Szenen des benutzerdefinierten Zusammen-Modus](~/apps-in-teams-meetings/teams-together-mode.md) |
