...
Partner Center unterstützt [lokalisierte Store-Einträge](/office/dev/store/prepare-localized-solutions). Weitere Informationen finden Sie unter [Localize your Teams app listing](../../../../concepts/build-and-test/apps-localization.md).
