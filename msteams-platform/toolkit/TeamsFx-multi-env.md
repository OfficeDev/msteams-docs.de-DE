...
1. **Testen vor der Produktion**: Es ist üblich, mehrere Umgebungen wie Entwicklung, Test und Staging einzurichten, bevor sie eine Teams App in der Produktionsumgebung im modernen App-Entwicklungslebenszyklus veröffentlichen.
...
- 1. Öffnen Sie die Konfigurationsdatei `.fx/configs/config.dev.json`.
- 2. Fügen Sie eine neue Eigenschaft des *Manifests > Beschreibung > kurz* mit Wert `my app description for dev`hinzu.
...
In diesem Szenario erfahren Sie, wie Sie die Beschreibung von Teams App `my app description` für alle Umgebungen festlegen.

Da die Teams App-Manifestvorlage für alle Umgebungen freigegeben ist, können wir den darin enthaltenen Beschreibungswert für unser Ziel aktualisieren:
