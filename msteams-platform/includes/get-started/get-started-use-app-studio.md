...
1. Um das App-Paket für Ihre Teams zu erstellen, wählen Sie die Registerkarte **Manifest-Editor** in **App Studio aus:**
...
1. Wählen Sie zum Ändern dieses App-Pakets **im Manifest-Editor die** Option Vorhandene App importieren **aus:**
...
1. Wählen **Sie Speichern** aus, um das Dialogfeld zu beenden. App Studio registriert Ihren Bot bei Microsoft und zeigt Den neuen Bot in der Botliste an. 
1. Öffnen Sie nun eine Textdatei im Editor, und kopieren Und fügen Sie Ihre neue Bot-ID ein.
...
1. Aktualisieren Sie die **Bot-Endpunktadresse** auf , und ersetzen Sie durch die URL, die Sie beim `https://yourteamsapp.ngrok.io/api/messages` `yourteamsapp.ngrok.io` Hosten Ihrer App verwendet haben.
...
1. Wählen **Sie Löschen** aus, um die Messagingerweiterung zu entfernen, wählen Sie **Einrichten** aus, und führen Sie die gleichen Schritte aus, die für [Bots verwendet werden.](#bots) Das **Dialogfeld Messagingerweiterung** wird angezeigt.
1. Wählen Sie die **Registerkarte Vorhandenen Bot verwenden** aus, und wählen Sie aus einem meiner **vorhandenen Bots aus.**
1. Wählen Sie den von Ihnen erstellten Bot im Dropdownmenü aus. Fügen Sie einen **Botnamen hinzu,** und wählen **Sie Speichern aus,** um das Dialogfeld zu schließen.
1. Wählen Sie **im Abschnitt Befehl** die Option Hinzufügen **aus.** Wenn Sie einen suchbasierten Befehl hinzufügen möchten, wählen Sie die Option Benutzern erlauben, Ihren Dienst nach Informationen zu fragen, und fügen Sie diesen **in eine Nachricht** ein.
...
1. Nachdem Sie die Informationen eingeben, wählen **Sie Speichern** aus, um das Dialogfeld zu schließen.
...
1. Aktualisieren Sie Ihre gehostete Anwendung mit der App-ID und dem Kennwort für Ihren Bot. Verwenden Sie für die Beispiel-App die gleiche App-ID und dasselbe Kennwort für Bot- und Messagingerweiterung. 
...
1. Wählen Sie **im Abschnitt** **Zu** einem Team hinzufügen das Feld Suchen aus, und wählen Sie ein Team aus, um die Beispiel-App hinzuzufügen. Sie können ein spezielles Team für Tests einrichten.
