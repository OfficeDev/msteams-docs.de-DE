...
Sie können Deeplinks zu Inhalten in Teams von Ihrer Registerkarte aus erstellen. Dies ist nützlich, wenn Ihre Registerkarte mit anderen Inhalten in Teams verknüpft werden muss, z. B. zu einem Kanal, einer Nachricht, einer anderen Registerkarte oder sogar zum Öffnen eines Planungsdialogfelds. Um einen Deeplink von Ihrer Registerkarte aus auszulösen, rufen Sie Folgendes auf:

```Javascript
microsoftTeams.executeDeepLink(/*deepLink*/);
```

Mit diesem Aufruf navigieren Sie zur richtigen URL oder lösen eine Clientaktion aus, wie z. B. das Öffnen eines Planungs- oder App-Installationsdialogfelds. Siehe nachstehendes Beispiel:
...
Sie können Deeplinks erstellen, um nur Audio- oder Audiovideoanrufe an einen einzelnen Benutzer oder eine Gruppe von Benutzern aufzurufen, indem Sie den Anruftyp als *Audio* oder *Av* festlegen und die Teilnehmer angeben. Nachdem der Deeplink aufgerufen wurde und bevor der Anruf erfolgt, fordert der Microsoft Teams-Client eine Bestätigung für den Anruf an. Im Falle eines Gruppenanrufs können Sie eine Gruppe von VoIP-Benutzern und eine Gruppe von PSTN-Benutzern mit demselben Deeplink-Aufruf anrufen.
