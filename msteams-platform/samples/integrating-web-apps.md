...
Alternativ können Sie eine Teams Registerkarte [mithilfe der SharePoint-Framework](/sharepoint/dev/spfx/integrate-with-teams-introduction)erstellen.
...
Stellen Sie sicher, dass [Sie Teams Entwurfsrichtlinien](../concepts/design/understand-use-cases.md) befolgen, damit Ihre App für Teams systemintern ist. Sie können vorhandene App-Inhalte nicht zu einer Teams Registerkarte migrieren. Weitere Informationen zum App-Design finden Sie unter [Fluent Design System](https://fluentsite.z22.web.core.windows.net/).
