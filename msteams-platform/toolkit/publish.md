...
Sie können eine benutzerdefinierte App zu Teams hinzufügen, indem Sie ein [App-Paket](../concepts/build-and-test/apps-package.md) in einer *.zip-Datei direkt in ein Team oder im persönlichen Kontext hochladen. Das Hinzufügen einer benutzerdefinierten App durch Hochladen eines App-Pakets wird als Querladen bezeichnet. Sie können die App testen, während sie in Teams hochgeladen wird. Sie können die App in den folgenden Szenarien erstellen und testen:
...
### <a name="to-build-your-app-to-zip-app-package-file"></a>So erstellen Sie Ihre App zur ZIP-App-Paketdatei

Sie müssen zuerst ausgeführt `Provision in the cloud` werden, bevor Sie das App-Paket erstellen. Die folgenden Schritte helfen Ihnen beim Erstellen des App-Pakets.

* Wählen Sie unter **"BEREITSTELLUNG**" **das Zip-Teams-Metadatenpaket** aus.<br>
    Das generierte App-Paket wird sich in `{your project folder}/build/appPackage/appPackage.{env}.zip` befinden.

### <a name="to-upload-app-package"></a>So laden Sie das App-Paket hoch

Führen Sie die folgenden Schritte aus, um das App-Paket hochzuladen:

1. Wählen Sie im Teams-Client "**Apps** > **verwalten"** >  aus,**um eine App hochzuladen**.
   ...
   **Ein App-Fenster hochladen** wird angezeigt.
...
2. Wählen Sie **Benutzerdefinierte App hochladen** aus.
   ...
   Jetzt wird die App in den Teams-Client quergeladen, und Sie können sie hinzufügen und anzeigen.

## <a name="publish-to-your-organization"></a>In Ihrer Organisation veröffentlichen

Wenn die App für die Verwendung in der Produktion bereit ist, können Sie die App mithilfe der Teams-App-Übermittlungs-API übermitteln, die von Graph-API aufgerufen wird. Die Teams-App-Übermittlungs-API ist eine integrierte Entwicklungsumgebung (IDE), z. B. Microsoft Visual Studio Code, die mit dem Teams-Toolkit installiert ist. Mit den folgenden Schritten können Sie die App in Ihrer Organisation veröffentlichen:

* [Veröffentlichen über das Teams-Toolkit](#publish-from-teams-toolkit)
* [Genehmigen im Admin Center](#approve-on-admin-center)

### <a name="publish-from-teams-toolkit"></a>Veröffentlichen über das Teams-Toolkit

Die folgenden Schritte helfen Ihnen beim Veröffentlichen der App über das Teams-Toolkit:

1. Sie können Ihre Teams-App auf eine der folgenden Arten veröffentlichen:
     * Wählen Sie " **In Teams veröffentlichen** " unter **"BEREITSTELLUNG** " in der Strukturansicht des Teams-Toolkits aus.
...
2 Wählen Sie **"Installieren" für Ihre Organisation** aus.
  ...
  Jetzt wurde die App erfolgreich im Verwaltungsportal veröffentlicht, und Es wird der folgende Hinweis angezeigt:

  :::image type="content" source="../assets/images/teams-toolkit-v2/teams toolkit fundamentals/confirm-publish.png" alt-text="Veröffentlichen bestätigen":::

  Jetzt ist die App im Admin Center " **Apps verwalten** " verfügbar, in dem Sie und der Administrator sie überprüfen und genehmigen können.
...
Das Teams-Toolkit für Visual Studio Code basiert auf der Teams-App-Übermittlungs-API und ermöglicht Es Ihnen, den Übermittlungs- und Genehmigungsprozess für benutzerdefinierte Apps in Teams zu automatisieren.
  ...
  > * Genehmigen oder Hochladen neuer benutzerdefinierter Apps in den App Store Ihrer Organisation.
  > * Blockieren oder Zulassen von Apps auf Organisationsebene.
  > * Fügen Sie Apps zu Teams hinzu.
  > * Kaufen Sie Dienste für Apps von Drittanbietern.
  > * Von Apps angeforderte Berechtigungen anzeigen.
  > * Erteilen der Administratorzustimmung für Apps.
...
1. Wählen Sie das :::image type="icon" source="../assets/images/teams-toolkit-v2/teams toolkit fundamentals/Showall.PNG"::: Symbol > **Teams-App** > **"Apps verwalten**" aus.
   ...
   Im Widget „Ausstehende Genehmigung“ oben auf der Seite erfahren Sie, wann eine benutzerdefinierte App zur Genehmigung übermittelt wird. In der Tabelle veröffentlicht eine neu übermittelte App automatisch den Status der übermittelten und blockierten Apps. Sie können die Veröffentlichungsstatusspalte in absteigender Reihenfolge sortieren, um die App zu finden.
...
1. Wählen Sie das Statusdropdown aus, und wechseln **Sie von "Gesendet** " zu **"Veröffentlichen"**.
