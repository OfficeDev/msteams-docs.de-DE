...
Öffnen Sie das App-Manifest ( `manifest.json` ), und legen Sie die folgenden Eigenschaften in fest [`staticTabs`](../../resources/schema/manifest-schema.md#statictabs) , die die Inhaltsseite ihrer Registerkarte definiert.
