...
ms.locfileid: "68833184"
---
# <a name="prerequisites-for-creating-your-teams-app"></a>Voraussetzungen für die Erstellung Ihrer Teams-App
...
* [Querladen der Berechtigung](#sideloading-permission)
...
| &nbsp; | Grundlegende Anforderungen | Für die Verwendung von| Für Umgebungstyp|
   | --- | --- | --- |
   | **Erforderlich** | &nbsp; | &nbsp; | &nbsp; |
   ...
   | &nbsp; | [Microsoft Teams](https://www.microsoft.com/microsoft-teams/download-app) | Arbeiten Sie mit allen Personen zusammen, mit denen Sie arbeiten, über Apps für Chats, Besprechungen, Anrufe – alles an einem Ort.| JavaScript und SPFx|
   | &nbsp; | [Node.js](https://nodejs.org/en/download/) | Back-End-JavaScript-Laufzeitumgebung. Verwenden Sie das neueste v16 LTS-Release.| JavaScript und SPFx|
   ...
   > [!NOTE]
   >
   > * Das Dokument wird mit Microsoft Teams Toolkit Version 4.0.0 und Nodejs Version 16 getestet.
   > * Speichern Sie einen Lesezeichen für den Microsoft Graph-Explorer, um mehr über Microsoft Graph-Dienste zu erfahren. Mit diesem browserbasierten Tool können Sie Microsoft Graph außerhalb einer App abfragen und darauf zugreifen.
...
| Konten | Für die Verwendung von| Für Umgebungstyp|
| --- | --- |
...
|[Azure-Konto](#azure-account)|Back-End-Ressourcen in Azure.| JavaScript und SPFx|
|[Administratorkonto der SharePoint-Sammlungswebsite](#sharepoint-collection-site-administrator-account) |Bereitstellung für das Hosting.| SPFx|
...
* **Microsoft-Geschäftskonto für Unternehmen**
  ...
  :::row:::
    ...
    :::column span="3":::
       ...
       Das Konto bietet Zugriff auf alle Microsoft-Clouddienste auf kleiner, mittlerer und unternehmensebene. Zu den Diensten gehören Azure, Microsoft Intune oder Microsoft 365. 
...
Um ein kostenloses Microsoft 365-Entwicklerkonto zu erstellen, nehmen Sie am Microsoft 365-Entwicklerprogramm teil, und führen Sie das folgende Konto aus:
...
Sie benötigen ein Azure-Konto zum Hosten einer Teams-App oder der Back-End-Ressourcen für Ihre Teams-App mithilfe des Teams-Toolkits in Visual Studio Code. In den folgenden Szenarien benötigen Sie ein Azure-Abonnement:

* Wenn Sie bereits über eine App bei einem anderen Cloudanbieter als Azure verfügen und die App auf der Teams-Plattform integrieren möchten, benötigen Sie ein Azure-Abonnement.
* Sie können ein Azure-Abonnement auswählen, um Ihre Back-End-Ressourcen mit einem anderen Cloudanbieter zu hosten, oder auf Ihren eigenen Servern, sofern diese über die öffentliche Domäne verfügbar sind.
...
Beim Erstellen einer Teams-App mithilfe der SPFx-Umgebung benötigen Sie bei der Bereitstellung für das Hosting ein Administratorkonto für die SharePoint-Sammlungswebsite. Wenn Sie einen Microsoft 365-Entwicklerprogrammmandanten verwenden, können Sie das Administratorkonto verwenden, das Sie zu diesem Zeitpunkt erstellt haben.

## <a name="sideloading-permission"></a>Querladen der Berechtigung
...
1. Wählen Sie auf der Symbolleiste des Teams-Toolkits :::image type="icon" source="../assets/images/teams-toolkit-v2/teams-toolkit-sidebar-icon.PNG"::: das Symbol Teams Toolkit aus.

   > [!NOTE]
   > Wenn die Option nicht angezeigt wird, lesen [Sie Installieren des Teams-Toolkits](install-Teams-Toolkit.md) , um die Teams Toolkit-Erweiterung in Visual Studio Code zu installieren.
1. Wählen Sie unter **KONTEN** die Option **Bei M365 anmelden** aus, und melden Sie sich bei Ihrem Microsoft 365-Konto an.
...
Wenn Sie über Administratorrechte verfügen, führen Sie die folgenden Schritte aus, um die benutzerdefinierte App mithilfe des Admin Centers hochzuladen:
  ...
  1. Wählen Sie **Global (organisationsweite Standardeinstellung) aus.**
  ...
  1. Stellen Sie die Umschaltfläche **Benutzerdefinierte Apps hochladen** auf die Position **Ein**.
     ...
     :::image type="content" source="../assets/images/teams-toolkit-v2/Upload-custom-apps.png" alt-text="Hochladen benutzerdefinierter Apps":::
  ...
  5. Wählen Sie **Speichern**.
     ...
     Stellen Sie sicher, dass Sie nun über die Berechtigung zum Querladen verfügen, indem Sie die Schritte [unter Überprüfen der Querladenberechtigung mithilfe von Visual Studio Code oder Teams-Client ausführen.](#sideloading-permission)
