...
---
# <a name="create-a-bot-for-teams"></a>Erstellen eines Bots für Teams
...
> * Identifizieren der Eigenschaften des App-Manifests und einiger für Bots relevanter Gerüste
> * Hosten eines bot lokal
> * Konfigurieren eines bot für Teams
> * Querladen und Testen eines bot in Microsoft Teams

## <a name="before-you-begin"></a>Bevor Sie beginnen:

Wenn Sie noch nicht eingerichtet haben, richten Sie Ihr Microsoft 365-Entwicklungs [Konto](building-real-world-app.md#set-up-your-development-account) und die [Teams-App-Tools](building-real-world-app.md#install-your-development-tools)ein.

## <a name="create-your-app-project-and-bot"></a>Erstellen Ihres App-Projekts und bot

Das Microsoft Teams-Toolkit hilft Ihnen, die folgenden Komponenten für Ihre APP einzurichten:

* **App-Projekt**: enthält das App-Manifest und für Bots relevante Gerüste
* **Bot**: konfiguriert einen neuen bot und registriert ihn mit dem Microsoft Azure bot-Dienst
...
* `title`: Ein bot-Befehlsname, den Benutzer im Teams-Client sehen.
...
1. Geben Sie in das Feld **bot-Endpunktadresse** den lokalen Webserver ein, auf dem Sie den bot hosten, und fügen Sie `/api/messages` ihn an.
...
1. Suchen und wählen Sie den bot aus, den Sie gerade quer geladene haben.<br/>
...
> [!NOTE]
> Wenn Sie nach dem Testen Ihres bot Codeänderungen vornehmen, beispielsweise aktualisieren, `botActivityHandler.js` müssen Sie Ihre APP erneut ausführen, um diese Änderungen in Microsoft Teams wiedergegeben anzuzeigen.
...
* [Sehen Sie sich an, was andere Teams-Bots mit einem unserer Beispiele tun können (GitHub)](https://github.com/microsoft/BotBuilder-Samples#teams-samples)
