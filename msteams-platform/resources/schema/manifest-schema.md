...
|`sharePointPreviewImage`|string|2048||Ein relativer Dateipfad zu einem Registerkartenvorschaubild für die Verwendung in SharePoint. Größe 1024 x 768. |
...
Teams Apps, die eine eigene SharePoint URLs erfordern, um ordnungsgemäß zu funktionieren, enthalten "{teamsitedomain}" in ihrer gültigen Domänenliste.
