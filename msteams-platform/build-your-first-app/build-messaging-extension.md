...
---
# <a name="build-your-first-messaging-extension-for-microsoft-teams"></a>Erstellen Ihrer ersten Messagingerweiterung für Microsoft Teams
...
In diesem Lernprogramm lernen Sie, einen Suchbefehl *(auch* als suchbasierte Messagingerweiterung bezeichnet) zu erstellen, der eine Verknüpfung zum Suchen nach externen Inhalten und zum Freigeben in Teams ist.  Benutzer können über das Verfassen- oder Befehlsfeld Teams auf Suchbefehle zugreifen.
...
1. Wählen **Sie Neuen Bot erstellen** aus, und klicken Sie dann auf **Botregistrierung erstellen.** Wenn der neue Bot erfolgreich ist, hat er den *Status "Registriert".* Jetzt wird Ihr Bot automatisch beim Microsoft Azure Bot Service registriert. 
...
* App-Gerüst: Das App-Gerüst stellt eine Datei im Stammverzeichnis Ihres Projekts zur Verfügung, um zu behandeln, wie Ihre Messagingerweiterung (oder technisch der Bot der Messagingerweiterung) auf Suchabfragen `botActivityHandler.js` in Teams reagiert. [](#4-configure-the-bot-for-your-messaging-extension)
...
1. Wählen Visual Studio Code die **F5-Taste** aus, um einen Teams-Webclient zu starten.
