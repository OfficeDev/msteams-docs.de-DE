...
| --- | --- | --- |
|11/29/2021|Interaktiver Modus zum Freigeben der Besprechungsphase.|[Freigegebene Besprechungsphase,](apps-in-teams-meetings/enable-and-configure-your-app-for-teams-meetings.md#shared-meeting-stage) [API-Referenzen für Besprechungs-Apps](apps-in-teams-meetings/API-references.md)und [Entwicklervorschau-Manifestschema](resources/schema/manifest-schema-dev-preview.md)|
...
|08/25/2021| Schrittweise Anleitung zum Erstellen eines Teams Bots mit einmaligem Anmelden (Single Sign-On, SSO) eingeführt.| Hinzufügen von Authentifizierung > Bots > [Schrittweise Anleitung zum Erstellen Teams Bots mit SSO](sbs-bots-with-sso.yml) |
...
|07/08/2021|Teams Mobile fügt Unterstützung für Apps in Besprechungen hinzu. | Erstellen von Apps für Teams Besprechungen > Erweiterung der [Besprechungs-App](apps-in-teams-meetings/meeting-app-extensibility.md) |
|06/28/2021|Integrieren sie die Funktion "Personenauswahl". | Integration in Teams > [Integration der Personenauswahlfunktion](concepts/device-capabilities/people-picker-capability.md) |  
