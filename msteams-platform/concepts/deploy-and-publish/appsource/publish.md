...
1. Bereiten Sie Ihre App auf die Übermittlung vor, indem Sie der [Prüfliste für die Übermittlung folgen.](prepare/submission-checklist.md)
...
* Versuchen Sie, von einem anderen Browser aus auf **den** Link "E-Mail-Adresse für erneutes Senden" zu zugreifen.
...
* Passen Sie den Spamfilter Ihres Servers so an, dass alle E-Mails von einem E-Mail-maccount@microsoft. **<span></span> com**.
...
Weitere Hilfe finden Sie in der Dokumentation [zum kommerziellen](/azure/marketplace/) Marketplace.
