...
1. Ändern Sie die Art und Weise, wie Knoten und npm installiert werden.
1. Ändern Sie den Namen der Umgebung, standardmäßig dessen **Staging**.
...
1. Wählen Sie auf der Bearbeitungsseite "Pipeline" **die Option "Variablen"** und dann **"Neue Variable**" aus.
