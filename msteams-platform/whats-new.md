...
| --- | --- | --- |
| 11/17/2021| Aktualisierte Richtlinien für Microsoft Teams Speicherüberprüfung|[Store Validierungsrichtlinien](~/concepts/deploy-and-publish/appsource/prepare/teams-store-validation-guidelines.md)|
...
|10/18/2021| Registerkarten verknüpfen Verbreitung und Phasenansicht. | Erstellen von Registerkarten > [Der Link "Registerkarten" entrollt und die Phasenansicht](tabs/tabs-link-unfurling.md) |
...
|06/25/2021| Schrittweise Anleitung zum Senden proaktiver Nachrichten eingeführt. | Erstellen von Bots > Bot-Unterhaltungen > proaktiven Nachrichten > [Schrittweise Anleitung zum Senden proaktiver Nachrichten](sbs-send-proactive.yml) |
...
| 10/05/2018 | Formatierungsinformationen für Karten wurden auf den Desktop-, iOS- und Android-Clients für Teams aktualisiert und getestet. | [Karten,](~/concepts/cards/cards.md) [Kartenformatierung](~/concepts/cards/cards-format.md) |
