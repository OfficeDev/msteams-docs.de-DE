...
Weitere Informationen zu den verfügbaren Features finden Sie unter: [Features in der Öffentlichen Entwicklervorschau für Microsoft Teams](~/resources/dev-preview/developer-preview-features.md).
