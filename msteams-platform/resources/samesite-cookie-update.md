...
## <a name="cookies-in-brief"></a>Cookies in Kürze
 ...
 |**Drittanbietercookie**|Ein Drittanbietercookie ist technisch identisch mit einem Cookie eines ersten Drittanbieters. Der Unterschied ist, dass Daten über eine Datenpartnerschaftsvereinbarung (z. B. Microsoft Teams Analyse und Berichterstellung) an [eine zweite Partei weitergegeben werden.](/microsoftteams/teams-analytics-and-reports/teams-reporting-reference) |
