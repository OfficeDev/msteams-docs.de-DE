...
Die neue APP-ID sollte etwa wie folgt `2322041b-72bf-459d-b107-f4f335bc35bd`aussehen:.
...
In diesem Beispiel wird auf der Registerkarte "Team" die Konfigurationsseite angezeigt. Klicken Sie am Ende des Eintrags auf das Symbol *...* , und wählen Sie im Dropdownmenü *Bearbeiten* aus. Ändern Sie die URL `https://yourteamsapp.ngrok.io/configure` dahin `yourteamsapp.ngrok.io` , wo Sie durch die URL ersetzt werden soll, die Sie beim Hosten Ihrer APP oben verwendet haben.
...
Persönliche Registerkarten werden auf der Registerkarte Team unterschiedlich dargestellt. Die *Registerkarte "Hello"* sollte bereits in der Liste "persönliche Registerkarten" angezeigt werden. Im Moment verfügt er über einen Platzhalter `com.contoso.helloworld.hellotab`Wert. Klicken Sie am Ende des Eintrags auf das Symbol *...* , und wählen Sie im Dropdownmenü *Bearbeiten* aus. Das folgende Dialogfeld wird angezeigt.
...
Fügen Sie einen bot-Namen `Contoso bot`wie ein, und klicken Sie auf die Schaltflächen unter *Bereich*.
