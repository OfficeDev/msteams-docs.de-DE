...
- Wählen Sie einen Kanal im Team aus, in dem Sie Ihre App registriert haben, und geben Sie diesen ein `@your-bot-name`. Diese Art von Nachricht wird als Erwähnung bezeichnet **\@**. Der Bot antwortet auf eine beliebige Nachricht, die Sie senden.
