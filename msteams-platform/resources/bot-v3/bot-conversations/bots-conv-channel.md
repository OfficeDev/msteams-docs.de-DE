...
* `channelData` Weitere Informationen [finden Sie unter Teams channel data](~/resources/bot-v3/bot-conversations/bots-conversations.md#teams-channel-data). Enthält in einem Gruppenchat spezifische Informationen für diesen Chat.
...
* Das Team ist groß (natürlich subjektiv, aber z. B. größer als 100 Mitglieder). Ihr Bot kann als "Spammy" betrachtet werden, und die Person, die ihn hinzugefügt hat, kann Beschwerden erhalten, es sei denn, Sie teilen die Wertversprechen Ihres Bots jedem klar mit, der die Willkommensnachricht sieht.
